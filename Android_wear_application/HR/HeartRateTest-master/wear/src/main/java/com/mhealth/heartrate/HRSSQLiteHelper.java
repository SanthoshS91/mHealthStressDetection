...
public class HRSSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + TABLEDATA.TABLE_NAME + " (" +
                    ...
                    TABLEDATA.COLUMN_NAME_HEART_RATE + " TEXT," +
...
*/
    ...
    public static Cursor getHREntries(Context context) {
        String selectQuery = "SELECT  * FROM " + TABLEDATA.TABLE_NAME;
        SQLiteDatabase sqlDb = getInstance(context).getReadableDatabase();
        Log.d(TAG, "selectQuery: " + selectQuery);
        Cursor cursor = sqlDb.rawQuery(selectQuery, null);
        return cursor;
    }

    public static void deleteHREntries(Context context) {
        String selectQuery = "delete from " + TABLEDATA.TABLE_NAME;
        SQLiteDatabase sqlDb = getInstance(context).getWritableDatabase();
